...
| Device Node | GPIO#0 | GPIO#1 | GPIO#2 | GPIO#3 |
| ----------  | ------ | ------ | ------ | ------ |
| /dev/ttyM10 |   400  |  401   |   402  |   403  |
| /dev/ttyM11 |   404  |  405   |   406  |   407  |
| /dev/ttyM12 |   408  |  409   |   410  |   411  |
| /dev/ttyM13 |   412  |  413   |   414  |   415  |
| /dev/ttyM14 |   384  |  385   |   386  |   387  |
| /dev/ttyM15 |   388  |  389   |   390  |   391  |
| /dev/ttyM16 |   392  |  393   |   394  |   395  |
| /dev/ttyM17 |   396  |  397   |   398  |   399  |
...
# to switch expansion module card B port 0 (/dev/ttyM10) to RS485-2W mode
...
# to switch expansion module card B port 7 (/dev/ttyM17) to RS422/RS485-4W mode
echo 0 > /sys/class/gpio/gpio396/value
